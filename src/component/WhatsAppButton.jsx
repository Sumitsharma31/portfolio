...
const WhatsAppButton = () => {
  ...
  const message = encodeURIComponent("Hi Sumit, I saw your portfolio and wanted to connect!");
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 p-4 bg-[#25D366] text-white rounded-full shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300 flex items-center justify-center group"
